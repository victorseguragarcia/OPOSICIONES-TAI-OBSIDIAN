...
- **Procedimiento Agravado / Extraordinario (Art. 168)**:
  ...
  - Aprobación del principio por **mayoría de 2/3 de cada Cámara** $ightarrow$ Disolución inmediata de las Cortes $ightarrow$ Nuevas Cortes ratifican la decisión y estudian el nuevo texto constitucional (aprobado por mayoría de 2/3 de ambas Cámaras) $ightarrow$ **Referéndum preceptivo y vinculante obligatoriamente**.
