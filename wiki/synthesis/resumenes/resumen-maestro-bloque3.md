---
title: "Resumen Maestro Bloque 3: Desarrollo de Sistemas, Bases de Datos, Web y Control de Calidad"
type: "synthesis"
tags:
  - resumen-bloque
  - bloque-3
...
# 🔴 Resumen Maestro Bloque 3: Desarrollo de Sistemas, Bases de Datos, Web y Control de Calidad

> [!repaso] ⚡ **Visión General del Bloque 3**
> 9 temas oficiales que incluyen el diseño relacional y normalización (1FN-5FN), SQL ANSI avanzado, desarrollo Java EE/.NET, desarrollo web frontend (HTML5/CSS3/ES6), servicios web (SOAP/REST), accesibilidad (WCAG 2.1), metodologías ágiles (Scrum, Git) y MÉTRICA v3.
...
- 📊 **Guía / Tabla Maestra**: [[wiki/synthesis/guia-maestra-snippets-comandos-examen-practico-tai|Guía de Referencia Rápida del Bloque 3]]
- 🃏 **Tarjetas de Memoria**: [[wiki/synthesis/tarjetas-memoria-flashcards-bloque3-desarrollo-bbdd|Mazo de Flashcards Bloque 3]]
- 🎯 **Simulacro Global del Bloque**: [[wiki/tests/bloques/simulacro-oficial-tai-100-preguntas-bloque1-4|Examen Simulacro Completo Bloque 3]]
