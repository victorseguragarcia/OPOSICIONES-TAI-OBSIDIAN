---
title: "Resumen Maestro Bloque 4: Sistemas, Redes, Comunicaciones y Seguridad de la Información"
type: "synthesis"
tags:
  - resumen-bloque
  - bloque-4
...
# 🔴 Resumen Maestro Bloque 4: Sistemas, Redes, Comunicaciones y Seguridad de la Información

> [!repaso] ⚡ **Visión General del Bloque 4**
> 10 temas oficiales que tratan la administración de servidores (Linux/Windows Server), Active Directory, virtualización y cloud, centros de datos y RAID, redes LAN y medios, pila TCP/IP y subnetting IPv4/IPv6, seguridad perimetral, criptografía y el ENS (RD 311/2022).
...
- 📊 **Guía / Tabla Maestra**: [[wiki/synthesis/guia-maestra-puertos-protocolos-rfc-seguridad|Guía de Referencia Rápida del Bloque 4]]
- 🃏 **Tarjetas de Memoria**: [[wiki/synthesis/tarjetas-memoria-flashcards-bloque4-sistemas-redes-seguridad|Mazo de Flashcards Bloque 4]]
- 🎯 **Simulacro Global del Bloque**: [[wiki/tests/bloques/simulacro-oficial-tai-100-preguntas-bloque1-4|Examen Simulacro Completo Bloque 4]]
