---
title: "Resumen Maestro Bloque 2: Tecnología Básica, Hardware, Sistemas Operativos y Bases de Datos"
type: "synthesis"
tags:
  - resumen-bloque
  - bloque-2
...
# 🔴 Resumen Maestro Bloque 2: Tecnología Básica, Hardware, Sistemas Operativos y Bases de Datos

> [!repaso] ⚡ **Visión General del Bloque 2**
> 5 temas oficiales que cubren la representación de la información (C2, IEEE 754), arquitectura de computadores y buses (PCIe, NVMe), estructuras de datos y algoritmos, gestión de procesos y memoria en SO, y SGBD relacionales y NoSQL.
...
- 📊 **Guía / Tabla Maestra**: [[wiki/synthesis/ieee-754-and-binary-representation-cheatsheet|Guía de Referencia Rápida del Bloque 2]]
- 🃏 **Tarjetas de Memoria**: [[wiki/synthesis/tarjetas-memoria-flashcards-bloque2-tecnologia-hardware|Mazo de Flashcards Bloque 2]]
- 🎯 **Simulacro Global del Bloque**: [[wiki/tests/bloques/simulacro-oficial-tai-100-preguntas-bloque1-4|Examen Simulacro Completo Bloque 2]]
