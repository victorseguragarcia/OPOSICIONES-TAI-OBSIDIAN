...
3. Invertir el **7º bit del primer octeto** (bit U/L - Universal/Local):
   - `00` en binario: `00000000` $ightarrow$ invirtiendo el 7º bit: `00000010` = `02`.
