...
# 🔴 Tema Completo Extendido 05 (Bloque 2): 
...
# 🔴 Bloque 2 - Tema 05 (UD012106): Sistemas Gestores de 
...
- Formas de acceso.
- Índices.
- Administrador de mantienen la Base de Datos. 
...
- Nivel Interno: describe la estructura física de almacenamiento de la base de datos, todos los detalles para su almacenamiento, y los caminos de acceso para acceder al dato. (Es el nivel más 
cercano al almacenamiento físico). 
- Nivel Externo (o de vistas): describe la parte de la base de datos que interesa a un grupo de usuarios determinado, como esos usuarios ven los datos, y les oculta el resto de la base de 
datos. Incluye diferentes vistas de usuario o esquemas. (Es el nivel más cercano a los usuarios, 
como ven los datos). 
- Nivel Conceptual: tiene un esquema conceptual que describe la estructura de la base de datos, pero oculta los detalles físicos del almacenamiento. Describir tipos de datos, entidades, vínculos, 
...
En 
transacciones de los sistemas de gestión de 
...
- Consistency (Consistencia, Integridad). Es la propiedad que asegura que sólo se empieza aquello que se puede acabar. Por lo tanto, se ejecutan aquellas operaciones que no van a romper 
...
- Durability (Durabilidad o Persistencia). Esta propiedad asegura que, una vez realizada la operación, esta persistirá y no se podrá deshacer, aunque falle el sistema y que de esta forma los 
...
En función a las diferentes formas de administración de datos, podemos clasificar las 
...
soluciona algunas deficiencias del modelo de 
...
Surgieron para mejorar las limitaciones de las 
recursivas. 
- 
Estas 
...
SQL (Structured Query Language) es la norma ANSI para los lenguajes relacionales de 
...
Codd definió doce reglas para identificar 
relacionales. 
...
- Tenga soporte de operaciones de definición de datos, operaciones de manipulación de datos (actualización, así como la recuperación), de control de la seguridad e integridad y 
...
- Regla 0:
Para que un sistema se denomine sistema de gestión de 
...
### 🔵 PostgreSQL 
También llamado Postgres. Es un sistema de gestión de 
...
de directorios. 
Algunos de los sistemas de administración de 
...
de intercambio de datos, con una representación binaria de 
...
programación OO (orientado a objetos) con capacidades de 
...
- Uniformidad.
### 🔵 5.2. Principales SGBDOO
A continuación presentamos varios Sistemas de Gestión de 
...
- Jasmine.
### 🔵 InterSystems Caché 
InterSystems Caché es un sistema comercial de administración de 
...
Lo que distingue a ObjectDB de otras 
...
### 🔵 Versant Object Database 
Versant Object Database (VOD) es un producto software para 
...
aplicaciones pequeñas o embebidas que requieren un sistema de 
...
### 🔵 FastObjects 
FastObjects es un Sistema de Gestión de 
...
adopción ha disminuido en favor de 
...
y componentes 
Ozone 
Ozone es un Sistema de Gestión de 
...
para aprender y explorar conceptos de 
...
### 🔵 Jasmine 
Jasmine es un Sistema de Gestión de 
...
y componentes 
### 🔵 6.2. Entre B.D (NoSQL) y las relacionales
### 🔵 Diferencias de bases NoSQL con las 
